...
export function ProfileSteam(props) {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            try {
                const result = await fetch(`${process.env.REACT_APP_URLProxy}/steam/findGetPlayerSummariesProxy/UserId/${props.steamId}/`, {
                    method: 'GET',
                    headers: {
            ...
            try {
                const page = 1;
                const result = await fetch(`${process.env.REACT_APP_URLProxy}/steam/findGetPlayerGamesProxy/Userid/${props.steamId}/${page}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        token: authToken
    ...
    async function buscarConquistasSteam(nextPage) {
        ...
        try {
          const result = await fetch(`${process.env.REACT_APP_URLProxy}/steam/findGetPlayerGamesProxy/Userid/${props.steamId}/${nextPage}`, {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
              token: authToken
